  ...
  data () {
    return {
      navigation: [
        ...
        { title: i18n.t('Our Expertise'), link: '/pages/our-expertise', isCms: true },
        ...
        { title: i18n.t('Returns'), link: '/pages/returns', isCms: true },
        { title: i18n.t('Our Promise'), link: '/pages/our-promise', isCms: true },
        { title: i18n.t('Expert Advice'), link: '/pages/expert-advice', isCms: true },
        { title: i18n.t('Terms of Sales-new'), link: '/pages/capitools-uk-terms-conditions', isCms: true },
        { title: i18n.t('Return Policy-new'), link: '/pages/returns-and-refunds-policy', isCms: true },
        { title: i18n.t('Partners-new'), link: '/pages/capitools-partners', isCms: true },
        { title: i18n.t('Cookie notice information'), link: '/pages/privacy', isCms: true },
